                            ...
                            >
                                <div className="space-y-6">
                                    <div className="text-center">
                                        <h2 className="text-2xl font-bold text-foreground mb-2">Recupera tu contraseña</h2>
                                    </div>
                                    <Form {...form}>
                                        <form onSubmit={form.handleSubmit(handleLogin)} className="space-y-4">
                                            ...
                                            <div className="flex items-center justify-between">
                                                <Link to="/auth" viewTransition className=" flex text-sm text-end text-orange-600 dark:text-orange-400 hover:text-orange-700 dark:hover:text-orange-300">
                                                    Volver
                                                </Link>
                                            </div>
                                            <Button
