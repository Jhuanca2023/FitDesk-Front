...
type Direction = 'btt' | 'ttb' | 'ltr' | 'rtl' | 'top-left' | 'top-right' | 'bottom-left' | 'bottom-right';
...
function getClipKeyframes(direction: Direction): [string, string] {
  switch (direction) {
    ...
    case 'bottom-left':
      return ['circle(0% at 0% 100%)', 'circle(150% at 0% 100%)'];
    case 'bottom-right':
      return ['circle(0% at 100% 100%)', 'circle(150% at 100% 100%)'];
    default:
      return ['inset(0 100% 0 0)', 'inset(0 0 0 0)'];
  }
}
